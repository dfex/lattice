...
def populateDB(dbconnection):
	...
	cur.execute("CREATE TABLE NodeTable (NodeID INTEGER PRIMARY KEY ASC, NodeName TEXT NOT NULL, NodeType TEXT NOT NULL, NodeIPAddress TEXT NOT NULL, LocationID TEXT, NodeStatus TEXT NOT NULL)")
	cur.execute("CREATE TABLE PortTable (PortID INTEGER PRIMARY KEY ASC, PortName TEXT NOT NULL, PortStatus TEXT, PortSpeed INTEGER, CustomerID TEXT, NodeID TEXT)")
	...
	cur.execute("CREATE TABLE SubInterfaceTable (SubInterfaceID INTEGER PRIMARY KEY ASC, SubInterfaceUnit INTEGER, SubInterfaceVLANID INTEGER, SubIntServiceID TEXT, SubInterfaceStatus TEXT NOT NULL, PortID TEXT)")
	cur.execute("CREATE TABLE AuthorisationTable (CustomerID TEXT, UserName TEXT, AuthorisationRole TEXT, PortID TEXT, SubInterfaceID TEXT)")
	cur.execute("CREATE TABLE ServiceMappingTable (ServiceID TEXT, SubInterfaceID TEXT)")
